...
export default class PixelPass extends Pass {
  ...
  render(renderer: THREE.WebGLRenderer, writeBuffer: THREE.WebGLRenderTarget) {
    ...
    uniforms.tDiffuse.value = this.diffuseRenderTarget.texture;
    uniforms.tDepth.value = this.depthTexture;
    uniforms.tNormal.value = this.normalRenderTarget.texture;
    uniforms.tGrassDiffuse.value = this.diffuseDepthlessRenderTarget.texture;
    uniforms.tGrassDepth.value = this.diffuseDepthlessRenderTarget.depthTexture;
